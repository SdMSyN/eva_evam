                    ...
                    <form id="formAdd" name="formAdd">
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="hidden" name="inputIdBloque" value="<?= $idBloque; ?>" >
        ...
        $(document).ready(function(){
           ...
           $('#formAdd').validate({
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../controllers/admin_create_banco_tema.php",
                        ...
                        success: function(msg){
                            ...
                            if(msg.error == 0){
                                ...
                                setTimeout(function () {
                                  location.href = 'admin_read_banco_temas.php?idNivel='+<?=$idNivel;?>+'&idGrado='+<?=$idGrado;?>+'&idMateria='+<?= $idMateria; ?>+'&idBloque='+<?= $idBloque; ?>;
                                }, 1500);
                            }else{
