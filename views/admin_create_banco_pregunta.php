    ...
    <div class="container">
        ...
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="admin_read_banco_preguntas.php?idNivel=<?=$idNivel;?>&idGrado=<?=$idGrado;?>&idMateria=<?=$idMateria;?>&idBloque=<?=$idBloque;?>&idTema=<?=$idTema;?>&idSubtema=<?=$idSubtema;?>">Preguntas</a></li>
        ...
        <div class="" id="contenedor" >
            <form id="formAdd" name="formAdd" class="form-horizontal">
                <div class="form-group">
                    ...
                    <input type="hidden" name="idBloque" value="<?=$idBloque;?>">
                    <input type="hidden" name="idTema" value="<?=$idTema;?>">
                    <input type="hidden" name="idSubtema" value="<?=$idSubtema;?>">
        ...
        $(document).ready(function(){ 
            $("#formAdd").validate({
                ...
                messages: {
                    ...
                    inputCompartir: "Debes seleccionar alguna",
                ...
                tooltip_options:{
                    ...
                    inputCompartir: {trigger: "focus", placement: "bottom"},
                    ...
                    $.ajax({
                        ...
                        success: function(msg){
                            ...
                            if(msg.error == 0){
                                ...
                                setTimeout(function () {
                                  location.href = 'admin_read_banco_preguntas.php?idNivel='+<?=$idNivel;?>+'&idGrado='+<?=$idGrado;?>+'&idMateria='+<?=$idMateria;?>+'&idBloque='+<?=$idBloque;?>+'&idTema='+<?=$idTema;?>+'&idSubtema=<?=$idSubtema;?>';
                                }, 1500);
                            }else{
                                $('#loading').empty();
