...
?>
    ...
    <div class="container">
        ...
        <div class="modal fade" id="modalSelDest" tabindex="-1" role="dialog" aria-labellebdy="myModal" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-6 text-center">
                                <a href="prof_create_notificacion_grupos.php" class="btn btn-primary">Grupos</a>
        ...
        <div class="modal fade" id="modalSelGrupo" tabindex="-1" role="dialog" aria-labellebdy="myModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="prof_create_notificacion_alumnos.php" class="form-horizontal">
        ...
        $(document).ready(function(){
           ...
           function filtrar(){
               $.ajax({
                   type: "POST",
                   data: ordenar, 
                   url: "../controllers/prof_read_notificaciones.php?idProf=<?=$idUser;?>",
           ...
           $.ajax({
                type: "POST", 
                url: "../controllers/prof_read_grados.php?idProf=<?=$idUser;?>",
                success: function(msg){
                    console.log(msg);
                    var msg = jQuery.parseJSON(msg);
                    if(msg.error == 0){
           ...
           $("#modalSelGrupo #inputGrado").on("change", function(){
               ...
               $.ajax({
                    type: "POST", 
                    url: "../controllers/prof_read_grupos_by_grado.php?idGrado="+grado+"&idProf=<?=$idUser;?>",
                    success: function(msg){
                        console.log(msg);
                        var msg = jQuery.parseJSON(msg);
                        if(msg.error == 0){
