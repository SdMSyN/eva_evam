                    ...
                    <form id="formAdd" name="formAdd">
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="hidden" name="inputNivel" value="<?=$idNivel;?>" >
                                <input type="hidden" name="inputGrado" value="<?=$idGrado;?>" >
        ...
        $(document).ready(function(){
                       ...
                       if(msg.error == 0){
                           ...
                           $.each(msg.dataRes, function(i, item){
                               var newRow = '<tr>'
                                    ...
                                    +'<td><a href="admin_read_banco_bloques.php?idNivel='+<?=$idNivel;?>+'&idGrado='+<?=$idGrado;?>+'&idMateria='+msg.dataRes[i].id+'" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span></a></td>'
                                    +'</tr>';
           ...
           $('#formAdd').validate({
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../controllers/admin_create_banco_materia.php",
                        ...
                        success: function(msg){
                            ...
                            if(msg.error == 0){
                                ...
                                setTimeout(function () {
                                  location.href = 'admin_read_banco_materias.php?idNivel='+<?=$idNivel;?>+'&idGrado='+<?=$idGrado;?>;
                                }, 1500);
                            }else{
