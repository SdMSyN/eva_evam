            ...
            <table class="table table-striped" id="data">
                ...
                <thead>
                    <tr>
                        ...
                        <th><span title="creado">Creado</span></th>
                        <th>Ver Temas</th>
                    </tr>
                </thead>
                <tbody></tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">Añadir nuevo bloque a la materia: <?= $nameMateria; ?></h4>
                        <p class="msgModal"></p>
                    </div>
                    <form id="formAdd" name="formAdd">
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="hidden" name="inputIdMateria" value="<?= $idMateria; ?>" >
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
                       ...
                       if(msg.error == 0){
                           ...
                           $.each(msg.dataRes, function(i, item){
                               var newRow = '<tr>'
                                    ...
                                    +'<td><a href="admin_read_banco_temas.php?idNivel='+<?=$idNivel;?>+'&idGrado='+<?=$idGrado;?>+'&idMateria='+<?=$idMateria;?>+'&idBloque='+msg.dataRes[i].id+'" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span></a></td>'
                                    +'</tr>';
           ...
           $('#formAdd').validate({
                ...
                messages: {
                    inputName: "Nombre del bloque obligatorio"
                },
                tooltip_options: {
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../controllers/admin_create_banco_bloque.php",
                        ...
                        success: function(msg){
                            ...
                            if(msg.error == 0){
                                ...
                                setTimeout(function () {
                                  location.href = 'admin_read_banco_bloques.php?idNivel='+<?=$idNivel;?>+'&idGrado='+<?=$idGrado;?>+'&idMateria='+<?= $idMateria; ?>;
                                }, 1500);
                            }else{
                            ...
                            alert("Error al crear nuevo bloque");
                        }
                    });
                }
