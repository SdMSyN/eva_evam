...
?>
    ...
    <div class="container">
        ...
        <div class="row placeholder text-center">
            ...
            <div class="col-sm-6 placeholder">
                <a href="admin_create_banco_pregunta.php?idNivel=<?=$idNivel;?>&idGrado=<?=$idGrado?>&idMateria=<?=$idMateria;?>&idBloque=<?=$idBloque;?>&idTema=<?=$idTema;?>" class="btn btn-primary btn-lg">
                    Añadir nueva pregunta al Tema <span class="glyphicon glyphicon-plus"></span>
                </a>
            </div>
        </div>
        <br>
                       ...
                       if(msg.error == 0){
                           ...
                           $.each(msg.dataRes, function(i, item){
                               var newRow = '<tr>'
                                    ...
                                    +'<td><a href="admin_read_banco_preguntas.php?idNivel='+<?=$idNivel;?>+'&idGrado='+<?=$idGrado;?>+'&idMateria='+<?=$idMateria;?>+'&idBloque='+<?=$idBloque;?>+'&idTema='+<?=$idTema;?>+'" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span></a></td>'
                                    +'</tr>';
