        ...
        $(document).ready(function(){
            ...
            function filtrar(){
                $.ajax({
                    type: "POST",
                    data: ordenar,
                    url: "../controllers/prof_read_grupo_alumnos.php?inputGrupo=<?=$idGrupo;?>",
            ...
            $('#formAdd').validate({
                ...
                messages: {
                    ...
                    'checkIdAlum[]': "Selecciona al menos un grupo",
                },
                tooltip_options: {
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../controllers/prof_create_notificacion_alumnos.php",
                        ...
                        success: function(msg){
                            ...
                            if(msg.error == 0){
                                ...
                                $('#loading').append('<img src="../assets/obj/success_256.png" height="300" width="400" >');
                                setTimeout(function () {
                                  location.href = 'prof_read_notificaciones.php';
                                }, 1500);
                            }else{
                                $('#loading').empty();
