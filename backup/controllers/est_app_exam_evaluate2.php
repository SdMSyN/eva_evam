<?php
    ...
    $sqlGetPregs = "SELECT * FROM $tExaPregs WHERE exa_info_id='$idExam' ";
    ...
    if($resGetPregs->num_rows > 0){
        ...
        while($rowGetPreg = $resGetPregs->fetch_assoc()){
            ...
            $sqlGetRespTmp = "SELECT * FROM $tExaTmp "
                    ...
                    . "AND exa_info_asig_id='$idExamAsig' AND pregunta_id='$idPreg' ";
            ...
            if($resGetRespTmp->num_rows > 0){
                ...
                if($tipoRespResp == 1){ //si es opción multiple 
                    $sqlGetCalifResp = "SELECT correcta FROM $tExaResps WHERE id='$respResp' ";
                    ...
                    for($i =0; $i < count($respResp2); $i++){
                        ...
                        $sqlGetCalifResp = "SELECT correcta FROM $tExaResps WHERE id='$idRespResp' ";
                        $resGetCalifResp = $con->query($sqlGetCalifResp);
                        $rowGetCalifResp = $resGetCalifResp->fetch_assoc();
                    ...
                    $sqlGetWordResp = "SELECT palabras FROM $tExaResps WHERE id='$respIdResp' ";
                ...
                $arrResp[] = array('idPreg'=>$idPreg, 'typeResp'=>$tipoRespPreg, 'idRespTmp'=>$idRespTmp, 'idResp'=>'', 'resp'=>'', 'calif'=>2);
                $numSinResp++;
                continue;
            }
            $countPregsResp++;
    ...
    if($ban){//Siquiera contesto, entonces
        ...
        $sqlInsertResultInfo = "INSERT INTO $tExaResultInfo "
                ...
                . "VALUES ('$idExam', '$idExamAsig', '$idUser', '$countNumPregs', '$countPregsResp', "
            ...
            foreach($arrResp as $datosResp => $datosRespPreg){
                ...
                if($datosRespPreg['typeResp'] == 1 || $datosRespPreg['typeResp'] == 2){
                    $sqlInsertResultPreg = "INSERT INTO $tExaResultPregs "
                            . "(exa_info_id, exa_info_asig_id, alumno_id, pregunta_id, tipo_resp_id, "
                            . "respuesta_id, respuesta, exa_result_info_id, calificacion, created, updated) "
                            . "VALUES ('$idExam','$idExamAsig','$idUser','$idPregData','$typeRespData',"
