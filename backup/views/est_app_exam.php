...
<?php
    ...
    if (!isset($_SESSION['sessU'])){
        ...
        $sqlGetTime = "SELECT id, hora_inicio FROM $tExaTime "
                . "WHERE exa_info_id='$idExam' AND exa_info_asig_id='$idExamAsig' AND alumno_id='$idUser' ";
        ...
        if($resGetTime->num_rows > 0){
            ...
            $sqlInsertTime = "INSERT INTO $tExaTime "
                    . "(exa_info_id, exa_info_asig_id, alumno_id, hora_inicio, created) "
                    . "VALUES ('$idExam', '$idExamAsig', '$idUser', '$timeNow', '$dateNow') ";
        ...
        $sqlGetLimitTime = "SELECT ADDTIME($tExaTime.hora_inicio, $tExaAsig.tiempo) as hora_final "
                . "FROM $tExaTime "
                . "INNER JOIN $tExaAsig ON $tExaAsig.id=$tExaTime.exa_info_asig_id "
                . "WHERE $tExaTime.exa_info_id='$idExam' AND $tExaTime.exa_info_asig_id='$idExamAsig' "
...
?>
        ...
        function show5(){
            ...
            var minInicioExa = parseInt(timeBegin2.substr(3,2));
             ...
             if(hour == "0" && min == "00" && sec == "00"){
                ...
                $.ajax({
                   method: "POST",
                   url: "../controllers/est_app_exam_evaluate2.php?idUser=<?=$idUser;?>&idExam=<?=$idExam;?>&idExamAsig=<?=$idExamAsig;?>&idExaTime=<?=$idExaTime;?>",
                   success: function(data){
                      ...
                      if(msg.error == 0){
                          ...
                          setTimeout(function () {
                            location.href = 'est_app_exam_result.php?idExam=<?=$idExam;?>&idUser=<?=$idUser;?>&idExamAsig=<?=$idExamAsig;?>';
                          }, 1500);
                      }else{
                          $('#loading').empty();
                ...
                myclock="<font size='5' face='Arial' ><b><font size='1'>Te quedan:</font></br>"+hour+":"+min+":"
                 +sec+" </b></font>";
    ...
    <script type="text/javascript">
        ...
        function load(page){
            ...
            $("#loader").fadeIn('slow');
            $.ajax({
                url: "../controllers/est_app_exam.php?idExam="+<?=$idExam;?>+'&idUser='+<?=$idUser;?>+'&idExamAsig='+<?=$idExamAsig;?>,
                data: parametros,
