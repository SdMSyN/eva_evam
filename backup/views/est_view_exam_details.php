...
?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#dataExa").on("click", "#delete", function(){
                ...
                if(confirm("¿Seguro que deseas eliminar esta pregunta?")){
                    $.ajax({
                         method: "POST",
                         url: "../controllers/prof_delete_preg.php?idPreg="+idPreg,
        ...
        function load(page){
            ...
            $("#loader").fadeIn('slow');
            $.ajax({
                url: "../controllers/est_view_exam_details.php?idExam=<?=$idExam;?>&idExamAsig=<?=$idExamAsig;?>&idUser=<?=$idUser;?>",
                data: parametros,
                        ...
                        if(msg.error == 0){
                            ...
                            $.each(msg.dataPregs, function(i, item){
                                var newPreg = '<div class="row"><div class="col-sm-12 text-center">';
                                        ...
                                        if(msg.dataPregs[i].calif == 0) newPreg += ' <span class="glyphicon glyphicon-remove-circle"></span>';
                                        else if(msg.dataPregs[i].calif == 1) newPreg += ' <span class="glyphicon glyphicon-ok-circle"></span>';
