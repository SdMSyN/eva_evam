                        ...
                        if(msg.error == 0){
                            ...
                            $.each(msg.dataPregs, function(i, item){
                                var newPreg = '<div class="row">'
                                        +'<div class="col-sm-6">' 
                                            +'<button type="button" class="btn btn-danger" id="delete" value="'+msg.dataPregs[i].id+'" >Eliminar Pregunta</button>' 
                                        +'</div>'
                                        +'<div class="col-sm-6 text-right">' 
                                            +'<a href="prof_add_preg.php?idExam=<?=$idExam;?>" class="btn btn-success" >Añadir Pregunta</a>' 
                                        +'</div>'
                                    +'</div>';
