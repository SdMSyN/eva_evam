...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-12-2018 a las 23:07:29
...
ALTER TABLE `usuarios_profesores`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `user` (`user`), ADD KEY `informacion_id` (`informacion_id`), ADD KEY `escuela_id` (`escuela_id`), ADD KEY `paquete_id` (`paquete_id`);
